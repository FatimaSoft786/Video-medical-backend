...
const { signup,login,fetchUserByID,verifyOtp,checkEmail,resetPassword,doctors,patients,doctorsAccounts,countData,reviews,fetchDoctorByID} = require('../Controller/Admin');
